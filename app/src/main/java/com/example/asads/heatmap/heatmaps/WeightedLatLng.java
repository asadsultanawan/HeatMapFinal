...
package com.example.asads.heatmap.heatmaps;
...
public class WeightedLatLng implements PointQuadTree.Item {
     ...
     */
    private static final SphericalMercatorProjection sProjection = new SphericalMercatorProjection(HeatmapTileProvider.WORLD_WIDTH);
